/**
 * @file BharatVaultAutofillService.kt
...
class BharatVaultAutofillService : AutofillService() {
    ...
    override fun onFillRequest(
        ...
        val app = application as BharatVaultApp
    ...
    private fun matchRecords(records: List<Record>, packageName: String, webDomain: String?): List<Record> {
        ...
        val appMap = (application as BharatVaultApp).catalog.appMap
