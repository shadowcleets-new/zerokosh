 ...
 */
package org.bharatvault.app.quickunlock
...
object QuickUnlockManager {
    ...
    private const val KEY_ALIAS = "bharatvault_quick_unlock"
    ...
    suspend fun enable(activity: FragmentActivity, app: BharatVaultApp, passphrase: ByteArray): Boolean {
     ...
     */
    suspend fun unlock(activity: FragmentActivity, app: BharatVaultApp): UnlockResult? {
        val prefs = rawPrefs(activity)
    ...
    fun disable(context: Context, app: BharatVaultApp) {
    ...
    private fun rawPrefs(context: Context) =
        context.getSharedPreferences("bharatvault_quick_unlock", Context.MODE_PRIVATE)
